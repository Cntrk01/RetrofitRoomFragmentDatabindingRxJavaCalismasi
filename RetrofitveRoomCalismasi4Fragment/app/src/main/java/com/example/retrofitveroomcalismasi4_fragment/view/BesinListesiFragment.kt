...
import com.example.retrofitveroomcalismasi4_fragment.adapter.BesinAdapter
...
class BesinListesiFragment : Fragment() {
    ...
    private val recyclerBesinAdapter = BesinAdapter(arrayListOf())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        besinListRecycler.layoutManager=LinearLayoutManager(requireContext())
        ...
        swipeRefreshLayout.setOnRefreshListener {
            ...
            viewModel.verileriInternettenAlSwipe()
